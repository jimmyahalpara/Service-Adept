...
<div id="providerContainer">
    ...
    <table id="providerList" class="w-100">
        ...
        <?php 
            foreach ($managers as $key => $value) {
                ...
                <form onsubmit=\'return confirm("Do you really want to remove this user as manager?")\' style="display:inline-block" method="POST" action="Controllers/deleteOtherUser.php"><input type="hidden" name="access_level" value="3"><input type="hidden" name="user_id" value="'.$currentUser -> id.'"><button type="submit" value="submit" name="submit" class="btn btn-warning">Delete Manager</button></form><form action="Controllers/deleteOtherUser.php" method="POST" onsubmit=\'return confirm("Do you really want to delete this user?")\' class="pl-1 d-inline-block"><input type="hidden" name="user_id" value="'.$currentUser -> id.'"><input type="hidden" name="access_level" value="3"><input type="hidden" name="delete_user" value="1"><button name="submit" value="submit" class="btn btn-danger">Delete User Permanently</button></form>';
    ...
    <div class="p-2">
        <button class="btn btn-primary" data-toggle="modal" data-target="#createUserModal">Create Manager</button>
    </div>
